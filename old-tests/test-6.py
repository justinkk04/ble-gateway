...
class PowerManager:
    ...
    READ_STAGGER = 1.5     # Seconds between READ commands (relay nodes need >1s)
    STALE_TIMEOUT = 12.0   # Seconds before marking node unresponsive
    COOLDOWN = 4.0         # Seconds between adjustments
